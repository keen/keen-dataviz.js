...
Dataviz.prototype.sortInterval = function(str){
  if (!arguments.length) return this.view['attributes'].sortInterval;
  this.view['attributes'].sortInterval = (str ? String(str) : null);
  if (this.view['attributes'].sortIntervals) {
    this.dataset.sortRows(this.view['attributes'].sortIntervals);
  }
  return this;
};
