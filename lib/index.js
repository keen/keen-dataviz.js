...
Dataviz.prototype.attributes = function(obj){
  if (this.config.showDeprecationWarnings) {
    console.log('.attributes() is deprecated. Use: new KeenDataviz({ _your_options_ })');
  }
...
Dataviz.prototype.chartOptions = function(obj){
  if (this.config.showDeprecationWarnings) {
    console.log('.chartOptions() is deprecated. Use: new KeenDataviz({ _your_options_ })');
  }
  if (!arguments.length) return this.config;
...
Dataviz.prototype.colors = function(arr){
  if (this.config.showDeprecationWarnings) {
    console.log('.colors() is deprecated. Use: new KeenDataviz({ colors: _your_options_ })');
  }
...
Dataviz.prototype.colorMapping = function(obj){
  if (this.config.showDeprecationWarnings) {
    console.log('.colorMapping() is deprecated. Use: new KeenDataviz({ colorMapping: _your_options_ })');
  }
...
Dataviz.prototype.dateFormat = function(val){
  if (this.config.showDeprecationWarnings) {
    console.log('.dateFormat() is deprecated. Use: new KeenDataviz({ dateFormat: _your_options_ })');
  }
...
Dataviz.prototype.indexBy = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.indexBy() is deprecated. Use: new KeenDataviz({ indexBy: _your_options_ })');
  }
...
Dataviz.prototype.labels = function(arr){
  if (this.config.showDeprecationWarnings) {
    console.log('.labels() is deprecated. Use: new KeenDataviz({ labels: _your_options_ })');
  }
  ...
  if (this.data()[0].length === 2 && !isDateString(this.data()[1][0])) {
    this.dataset.updateColumn(0, function(value, index){
      if (this.config.labels[index-1]) {
        return stripHtmlTags(String(this.config.labels[index-1]));
      }
    ...
    this.dataset.updateRow(0, function(value, index){
      if (index > 0 && this.config.labels[index-1]) {
        return stripHtmlTags(String(this.config.labels[index-1]));
      }
      return stripHtmlTags(value);
    }.bind(this));
...
Dataviz.prototype.labelMapping = function(obj){
  if (this.config.showDeprecationWarnings) {
    console.log('.labelMapping() is deprecated. Use: new KeenDataviz({ labelMapping: _your_options_ })');
  }
  ...
  if (this.data()[0].length === 2 && !isDateString(this.data()[1][0])) {
    this.dataset.updateColumn(0, function(value){
      if (this.config.labelMapping[value]) {
        return stripHtmlTags(String(this.config.labelMapping[value]));
      }
      return stripHtmlTags(value);
    }.bind(this));
  }
...
Dataviz.prototype.notes = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.notes() is deprecated. Use: new KeenDataviz({ notes: _your_options_ })');
  }
...
Dataviz.prototype.render = function(rawData = undefined){
    ...
    if (!type) {
      const msg = `Chart type is undefined.`;
      this.message(msg);
      throw msg;
      return;
    }
...
Dataviz.prototype.sortGroups = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.sortGroups() is deprecated. Use: new KeenDataviz({ sortGroups: _your_options_ })');
  }
  if (!arguments.length) return this.config.sortGroups;
  this.config.sortGroups = (str ? String(str) : null);

  // Sort groups
  if (this.config.sortGroups && this.data().length > 1) {
    if (isDateString(this.data()[1][0])) {
      this.dataset.sortColumns(this.config.sortGroups, this.dataset.getColumnSum);
    }
    else {
      this.dataset.sortRows(this.config.sortGroups, this.dataset.getRowSum);
    }
  }
  return this;
};
...
Dataviz.prototype.sortIntervals = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.sortIntervals() is deprecated. Use: new KeenDataviz({ sortIntervals: _your_options_ })');
  }
  ...
  if (this.config.sortIntervals) {
    this.dataset.sortRows(this.config.sortIntervals);
  }
  return this;
};
...
Dataviz.prototype.stacked = function(bool){
  if (this.config.showDeprecationWarnings) {
    console.log('.stacked() is deprecated. Use: new KeenDataviz({ stacked: _your_options_ })');
  }
...
Dataviz.prototype.theme = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.theme() is deprecated. Use: new KeenDataviz({ theme: _your_options_ })');
  }
...
Dataviz.prototype.title = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.title() is deprecated. Use: new KeenDataviz({ title: _your_options_ })');
  }
...
Dataviz.prototype.type = function(str){
  if (this.config.showDeprecationWarnings) {
    console.log('.type() is deprecated. Use: new KeenDataviz({ type: _your_options_ })');
  }
