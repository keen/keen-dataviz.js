...
export const Dataviz = function (options = {}) {
  ...
  const defaultOptions = {
    ...
    // width: undefined, *deprecated* - use CSS to control the size
    // height: undefined, *deprecated* - use CSS to control the size
    title: undefined,
    notes: undefined,
    theme: 'keen-dataviz',
    legend: {
...
Dataviz.prototype.attributes = function(obj){
  console.log('.attributes() is deprecated - use Config object');
...
Dataviz.prototype.chartOptions = function(obj){
  console.log('.chartOptions() is deprecated - use Config object');
  if (!arguments.length) return this.config;
...
Dataviz.prototype.colors = function(arr){
  console.log('.colors() is deprecated - use Config object');
...
Dataviz.prototype.colorMapping = function(obj){
  console.log('.colorMapping() is deprecated - use Config object');
...
Dataviz.prototype.height = function(num){
  console.log('.height() is deprecated - use CSS to control the size');
  if (!arguments.length) return this.config.height;
  // this.config.height = (!isNaN(parseInt(num)) ? parseInt(num) : null);
  return this;
};
...
Dataviz.prototype.render = function(){
    ...
    if (!type) {
      const msg = `A chart type is required. Check out the .type() method.`;
      this.message(msg);
      throw msg;
      return;
    }
...
Dataviz.prototype.width = function(num){
    console.log('.width() is deprecated - use CSS to control the size');
    if (!arguments.length) return this.config.width;
    // this.config.width = (!isNaN(parseInt(num)) ? parseInt(num) : null);
    return this;
};
...
function buildDomWrapper(el, options) {
  ...
  html += `<div class="${options.theme}-rendering">${container}</div>`;
  if (options.notes) {
