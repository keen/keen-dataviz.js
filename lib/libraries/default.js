  ...
  each(c3Types, function(type, index) {
    types[type] = {
      render: function(){
        ...
        // var newHtml = '';
        // newHtml += '<div class="' + this.theme() + '-rendering"></div>';
        // newHtml += '<div class="' + this.theme() + '-c3">';
        // newHtml +=   '<div class="' + this.theme() + '-c3-legend"></div>';
        // newHtml += '</div>';
        // this.el().querySelector('.' + this.theme() + '-stage').innerHTML = newHtml;
        ...
        // if (options.legend.show === true
        //   && options.legend.position === 'right'
        //     && ['gauge', 'pie', 'donut', 'table'].indexOf(type.replace('horizontal-', '')) < 0) {
        //       renderCustomLegend.call(this, options.data.columns);
        // }
