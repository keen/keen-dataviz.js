      ...
      tooltip: {
        ...
        format: {
          value: function(value, ratio, id){
            // var scope = chart.dataset.selectRow(0).slice(PAGINATION_START, PAGINATION_END);
            // if (scope.indexOf(id) > -1) {
            //   return value;
            // }
            // console.log(id, this.view._artifacts);
            return value;
          }.bind(this)
        }
      },
  ...
  each(c3Types, function(type, index) {
    types[type] = {
      render: function(){
        ...
        // options.tooltip.contents = c3TooltipContents;
