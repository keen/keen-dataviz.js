  ...
  bindResizeListener(function(){
    ...
    timer = setTimeout(function(){
      each(lib.visuals, function(chart){
        ...
        if (c3Chart) {
          // console.log(c3Chart.internal.config.padding_bottom,
            // c3Chart.internal.config.padding_top,
            // c3Chart.internal.config.padding_left,
            // c3Chart.internal.config.padding_right);
          // let verticalPadding = 0;
          // let horizontalPadding = 0;
          // if (c3Chart.internal.config.padding_bottom) verticalPadding += c3Chart.internal.config.padding_bottom;
          // if (c3Chart.internal.config.padding_top) verticalPadding += c3Chart.internal.config.padding_top;
          // if (c3Chart.internal.config.padding_left) horizontalPadding += c3Chart.internal.config.padding_left;
          // if (c3Chart.internal.config.padding_right) horizontalPadding += c3Chart.internal.config.padding_right;
          const width = c3Chart.element.parentNode.offsetWidth;
          const height = c3Chart.element.parentNode.offsetHeight;
          // chart.view._artifacts.c3.resize();
          chart.view._artifacts.c3.resize({
            height,
            width
          });
          // chart.view._artifacts.c3.flush();
        }
      });
    }, delay);
  });
...
function defineC3(){
  ...
  function getDefaultOptions(){
    ...
    const ENFORCED_OPTIONS = {
      ...
      onresized: function() {console.log('===== RESIZED');}
    };
