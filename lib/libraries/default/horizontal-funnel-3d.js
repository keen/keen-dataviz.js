...
export default class HorizontalFunnel3d {
  render() {
    ...
    const margin = { top: 0, right: 30, bottom: 100, left: 10 };
    ...
    if(lines){
      ...
      chart
        ...
        .attr('y2', polygons[polygons.length-1].points[3].y)
        .attr('class', 'chart-lines');
    }
    ...
    if(lines){
      chart
        ...
        .attr('y', svgHeight + (margin.bottom * 0.4))
