export default {
  render: function(){
    ...
    const height = this.config.height || 35;
    const offsetPadding = (height - 35) / 2;
    const prefixes = ['webkit', 'Moz', 'ms', 'O'];
    let radius = this.view._artifacts.radius = 0;
    ...
    const spinner = this.el().querySelector('.keen-spinner-indicator');
